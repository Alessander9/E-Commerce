...
const productCategories: ListItemType[] = [
  {
...
const careFeatures: ListItemType[] = [
  {
    title: "Aglomeración 3s",
    href: "/#descubre-perucat",
    description: "Terrones compactos y fáciles de retirar.",
    icon: ShieldCheck,
  },
  {
    title: "99.5% Libre de Polvo",
    href: "/#descubre-perucat",
    description: "Protege las vías respiratorias y patitas.",
    icon: Sparkles,
  },
  {
    title: "Envíos a Todo el Perú",
    href: "/productos",
    description: "Despacho express en Lima y Provincias.",
    icon: Package,
  },
  {
    title: "Todo el Catálogo",
    href: "/productos",
    description: "Explora todas nuestras variedades y stock disponible.",
    icon: Layers,
  },
];
...
export function NavigationMenu4() {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/95 backdrop-blur-md border-b border-gray-100 shadow-xs">
      {/* Top Banner (Optional Admin Info) */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
        ...
        <div className="hidden lg:flex items-center justify-center flex-1">
          <NavigationMenu>
            <NavigationMenuList>
              ...
              {/* Menu 1: Colecciones / Arenas Sanitarias */}
              <NavigationMenuItem>
                    ...
                    <li className="rounded-2xl overflow-hidden bg-gradient-to-br from-navy to-[#182a57] text-white p-4 flex flex-col justify-between relative group">
                      <div className="relative z-10 space-y-2">
                        ...
                        <p className="text-[11px] text-gray-300 leading-relaxed">
                          Terrones ultra compactos al instante y 99.5% libre de polvo.
                        </p>
                      </div>
        ...
        {/* Right: Search, Wishlist, Cart & Login/Profile Button */}
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          >
            ...
            {wishlistCount > 0 && (
              <span className="absolute 1 top-1 right-1 w-4 h-4 rounded-full bg-rose-500 text-white text-[10px] font-black flex items-center justify-center shadow-xs">
                {wishlistCount}
              </span>
            )}
          </Link>
