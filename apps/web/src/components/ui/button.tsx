...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-grad-primary text-white hover:bg-grad-primary-hover shadow-glow-primary hover:shadow-glow-secondary",
        destructive:
          "bg-danger text-white hover:bg-red-600",
        outline:
          "border border-gray-200 bg-white hover:bg-gray-50 text-navy hover:text-primary hover:border-primary/40",
        secondary:
          "bg-secondary text-white hover:bg-secondary-hover",
        ghost: "hover:bg-primary/10 hover:text-primary text-navy",
